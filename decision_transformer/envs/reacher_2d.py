...
class Reacher2dEnv(MujocoEnv, utils.EzPickle):
    
    def __init__(self):
        self.fingertip_sid = 0
        self.target_bid = 0
        curr_dir = os.path.dirname(os.path.abspath(__file__))
        MujocoEnv.__init__(self, curr_dir+'/assets/reacher_2d.xml', 15)
    ...
    def step(self, action):
        ...
        truncated = False
        ob = self._get_obs()
        return ob, reward, terminated, truncated, dict(reward_dist=reward_dist, reward_ctrl=reward_ctrl, reward_bonus=reward_bonus)
